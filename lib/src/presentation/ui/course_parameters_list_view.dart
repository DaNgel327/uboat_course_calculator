                                ...
                                builder: (context, state) {
                                  return Column(
                                    ...
                                    children: <Widget>[
                                      ...
                                      if (state.courseParameters != null)
                                        Row(
                                          children: <Widget>[
                                            _TextWithUnits(
                                              parameter: courseParametersListData,
                                              data: switch (
                                                  courseParametersListData.parameterType) {
                                                ParameterType.distance =>
                                                  state.courseParameters!.distance,
                                                ParameterType.scope =>
                                                  state.courseParameters!.scope.value,
                                                ParameterType.scale =>
                                                  state.courseParameters!.periscopeScaleValue,
                                                ParameterType.boatLength =>
                                                  state.courseParameters!.boatLength,
                                              },
                                            ),
                                          ],
                                        )
